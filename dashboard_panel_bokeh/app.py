...
TEXT = {
    "EN": {
        ...
        "observed_salary_records": "Observed salary records",
        "filtered_salary_records": "Filtered salary records",
        ...
        "compensation_text": "Compare how observed compensation ranges evolve with experience across remote, hybrid, and in-person work.",
        ...
        "compensation_experience_subtitle": "Observed salary records only; median-imputed values are excluded.",
    ...
    "ES": {
        ...
        "observed_salary_records": "Registros salariales observados",
        "filtered_salary_records": "Registros salariales filtrados",
        ...
        "compensation_text": "Compara cómo evolucionan los rangos de compensación observada con la experiencia en trabajo remoto, híbrido y presencial.",
        ...
        "compensation_experience_subtitle": "Solo registros salariales observados; se excluyen valores imputados por mediana.",
...
def dashboard_kpis(
    ...
    return _grid_box(
        ...
        _kpi_card(
            ...
            _text("observed_salary_records", lang),
            f"${kpis['average_salary']:,.0f}",
            _text("filtered_salary_records", lang),
            theme,
        ),
        ncols=3,
    )
